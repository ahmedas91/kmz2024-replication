...
\title[VoC Replication]{
The Virtue of Complexity in Return Prediction: A Replication
}
\author[]{Ahmed Alahmadi \and Jeff Key}
\institute[UChicago]{FINM 32900, The University of Chicago}
\date{\today}
...
\begin{frame}
\frametitle{Figure 8 replication: performance rises with complexity}
\centering
\includegraphics[width=0.95\linewidth]{\PathToOutput/figure8.png}
\end{frame}
